...
fun CreateBook(navController: NavHostController, isDrawerOpen: MutableState<Boolean>){
    LaunchedEffect(Unit){
    ...
    val publisher = remember { mutableStateOf(TextFieldValue()) }
    ...
    Box(
        ...
        Column {
            BarTop(navController =navController , isDrawerOpe = isDrawerOpen, title = "Crear libro")
            Card(
